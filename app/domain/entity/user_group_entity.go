...
// WechatMallUserGroupDO CMS-后台用户分组表
type WechatMallUserGroupDO struct {
	...
	Description string    `gorm:"column:description;NOT NULL"`                           // 分组描述
...
func (m *WechatMallUserGroupDO) TableName() string {
	return "wechat_mall_user_group"
}

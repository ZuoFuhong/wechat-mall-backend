...
func registerHandler(router *mux.Router, cmsHandler *cms.Handler, portalHandler *portal.Handler) {
	...
	router.Handle("/cms/admin/user", chain.ThenFunc(cmsHandler.GetUser)).Methods("GET").Queries("id", "{id}")
	router.Handle("/cms/admin/user", chain.ThenFunc(cmsHandler.DoDeleteCMSUser)).Methods("DELETE").Queries("id", "{id}")
	router.Handle("/cms/admin/reset_password", chain.ThenFunc(cmsHandler.DoResetCMSUserPassword)).Methods("POST")
	...
	router.Handle("/cms/admin/group", chain.ThenFunc(cmsHandler.GetUserGroup)).Methods("GET").Queries("id", "{id}")
	...
	router.Handle("/cms/category/list", chain.ThenFunc(cmsHandler.GetCategoryList)).Methods("GET").Queries("pid", "{pid}").Queries("page", "{page}").Queries("size", "{size}")
	...
	router.Handle("/cms/category/all", chain.ThenFunc(cmsHandler.GetChooseCategory)).Methods("GET")
	...
	router.Handle("/cms/goods/list", chain.ThenFunc(cmsHandler.GetGoodsList)).Methods("GET").Queries("k", "{k}").Queries("c", "{c}").Queries("o", "{o}").Queries("page", "{page}").Queries("size", "{size}")
	...
	router.Handle("/cms/goods/all", chain.ThenFunc(cmsHandler.GetChooseCategoryGoods)).Methods("GET")

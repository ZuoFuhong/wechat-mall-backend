...
func registerHandler(router *mux.Router, handler *handler.Handler) {
	...
	router.Handle("/cms/banner/list", chain.ThenFunc(handler.CMSHandler.GetBannerList)).Methods("GET").Queries("page", "{page}").Queries("size", "{size}")
	...
	router.Handle("/cms/banner_item/list", chain.ThenFunc(handler.CMSHandler.GetBannerItemList)).Methods("GET").Queries("bannerId", "{bannerId}")
	...
	router.Handle("/cms/category/list", chain.ThenFunc(handler.CMSHandler.GetCategoryList)).Methods("GET").Queries("page", "{page}").Queries("size", "{size}")
	...
	router.Handle("/cms/grid_category/list", chain.ThenFunc(handler.CMSHandler.GetGridCategoryList)).Methods("GET").Queries("page", "{page}").Queries("size", "{size}")
	...
	router.Handle("/cms/spec/list", chain.ThenFunc(handler.CMSHandler.GetSpecificationList)).Methods("GET").Queries("page", "{page}").Queries("size", "{size}")
	...
	router.Handle("/cms/spec/attr/list", chain.ThenFunc(handler.CMSHandler.GetSpecificationAttrList)).Methods("GET").Queries("specId", "{specId}")
	...
	router.Handle("/cms/spu/list", chain.ThenFunc(handler.CMSHandler.GetSPUList)).Methods("GET").Queries("page", "{page}").Queries("size", "{size}")
	...
	router.Handle("/cms/spu/spec", chain.ThenFunc(handler.CMSHandler.GetSPUSpecList)).Methods("GET").Queries("spuId", "{spuId}")
	router.Handle("/cms/sku/list", chain.ThenFunc(handler.CMSHandler.GetSKUList)).Methods("GET").Queries("page", "{page}").Queries("size", "{size}")
	...
	router.Handle("/cms/activity/list", chain.ThenFunc(handler.CMSHandler.GetActivityList)).Methods("GET").Queries("page", "{page}").Queries("size", "{size}")
	...
	router.Handle("/cms/activity/{id:[0-9]+}", chain.ThenFunc(handler.CMSHandler.DoDeleteActivity)).Methods("DELETE")
	router.Handle("/cms/coupon/list", chain.ThenFunc(handler.CMSHandler.GetCouponList)).Methods("GET").Queries("activityId", "{activityId}")

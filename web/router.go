...
func (r *Router) registerHandler(services *interfaces.MallHttpServiceImpl) {
	...
	r.Handle("/cms/grid_category/list", r.ch.ThenFunc(services.GetCmsGridCategoryList)).Methods("GET", "OPTIONS").Queries("page", "{page}").Queries("size", "{size}")
	...
	r.Handle("/cms/goods/list", r.ch.ThenFunc(services.GetCmsGoodsList)).Methods("GET", "OPTIONS").Queries("k", "{k}").Queries("c", "{c}").Queries("o", "{o}").Queries("page", "{page}").Queries("size", "{size}")
	...
	r.Handle("/cms/coupon/list", r.ch.ThenFunc(services.GetCmsCouponList)).Methods("GET", "OPTIONS").Queries("page", "{page}").Queries("size", "{size}")
	...
	r.Handle("/cms/order/list", r.ch.ThenFunc(services.GetCmsOrderList)).Methods("GET", "OPTIONS").Queries("status", "{status}").Queries("stype", "{stype}").Queries("k", "{k}").Queries("st", "{st}").Queries("et", "{et}").Queries("p", "{p}").Queries("s", "{s}")
	r.Handle("/cms/order", r.ch.ThenFunc(services.GetCmsOrderDetail)).Methods("GET", "OPTIONS").Queries("orderNo", "{orderNo}")
